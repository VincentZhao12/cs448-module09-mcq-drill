...
The leaderboard uses Supabase from a static GitHub Pages site. Each browser gets a local UUID in `localStorage`; there is no login. This app is configured for the `cs448-leaderboard` Supabase project in `VincentZhao12's Org`.
